 ...
 */
package aem.sixfive.aemtools.core.listeners;
...
/** A service to demonstrate how changes in the resource tree can be listened for. Please note, that apart from EventHandler services, the
 * immediate flag should not be set on a service. */
